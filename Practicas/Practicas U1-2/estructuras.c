...
2.2 Datos definidos por el usuario (Usuario del programa o Programador)
    ...
    Los datos (variables o constantes) empleados hasta el momento, quedan en localidades de memoria distintas, es decir, dispersos
    en el lenguaje C el programador cuenta con dos formas de tenerlas reunidas en una sola area de memoria, ellas son:
         1. Uniones.
         2. Estructuras.
    Con ellas el programador podra reunir lo necesario para abordar problemas complejos y programarlos de forma simple y rapida.

2.2.1 Declaracion de una Estructura.

    Las estructuras en el lenguaje C emplean la palabra reservada "struct", para declararlaes necesario ponerle nombre a la estructura,
    se recomienda lo siguiente:
        1. Tratar el nombre de la estructura como NombrePropio (sustantivo o pronombre).
        2. El nombre de la estructura debe estar escrito en singular.
    la sintacis de una estructura es la siguiente:
